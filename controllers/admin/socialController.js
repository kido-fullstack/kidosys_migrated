...
const AMELIO_FACEBOOK_PAGE_ACCESS_TOKEN = 'EAAQFNZBo9gNsBO6qNXC7JBAOUYfb1KLzwnofZA3bCJ76HWepJcMPuiQHhvQhbgNVZCXZCWIjbEtFc9FWTbXfOPAiBGKr3sx43pZBeGZCd5HAlJO9rxVYOrxUOWHkMFIs2PzEoMFtxsYN2lI7IRqAeC4GdInJ553N5VzXRRxWR5Wz9gguD707O3Bi32';
...
try{
    fs.appendFile("../outfile.txt", JSON.stringify(req.body)+"\n\n\n", (err) => {
      // return res.send('working');
    });
  }catch(e){
    console.log(e);
