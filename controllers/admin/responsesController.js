...
exports.whatsappResponse = async (req, res, next) => {
  try {
    ...
    const saveFeed = new Feed({
      ...
      medium: checkwhastapp == "whatsapp" ? "Whatsapp" : "E-mail",
      count: feed + 1,
